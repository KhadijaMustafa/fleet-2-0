...
class UpdateEmployeeList extends StatefulWidget {
  final item;
  UpdateEmployeeList({Key? key, this.item}) : super(key: key);

  @override
  State<UpdateEmployeeList> createState() => _UpdateEmployeeListState();
}

class _UpdateEmployeeListState extends State<UpdateEmployeeList> {
  ...
  getValue() async {
    ...
    try {
      ...
      employeeN=listvalues["empNumber"];
      nameeng.text = listvalues["nameEng"];
      nameurd.text = listvalues["nameUrd"];
      contactnum.text = listvalues["contact"];

      positiontype = {
        'value': listvalues['positionId'],
        'text': listvalues['positionName']
      };
