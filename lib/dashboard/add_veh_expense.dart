...
class AddVehicleExpense extends StatefulWidget {
  final expenseList;
  AddVehicleExpense({Key? key, this.expenseList}) : super(key: key);

  @override
  State<AddVehicleExpense> createState() => _AddVehicleExpenseState();
}

class _AddVehicleExpenseState extends State<AddVehicleExpense> {
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: plotDropDown ? Colors.red : Colors.grey,
                    )),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(30),
                    border: Border.all(
                      color: expDropDowm ? Colors.red : Colors.grey,
                    )),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(30),
                    border:
                        Border.all(color: amount ? Colors.red : Colors.grey)),
                child: TextFormField(
                  autovalidateMode: AutovalidateMode.onUserInteraction,
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(30),
                    border:
                        Border.all(color: setdate ? Colors.red : Colors.grey)),
                child: Row(
             ...
             // file ? validationCont() : Container(),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    border:
                        Border.all(color: remark ? Colors.red : Colors.grey)),
                child: TextFormField(
                  autovalidateMode: AutovalidateMode.onUserInteraction,
