...
class UpdateEmployeeExpense extends StatefulWidget {
  final item;
  UpdateEmployeeExpense({Key? key, this.item}) : super(key: key);

  @override
  State<UpdateEmployeeExpense> createState() => _UpdateEmployeeExpenseState();
}

class _UpdateEmployeeExpenseState extends State<UpdateEmployeeExpense> {
  ...
  void initState() {
    ...
    getListCall();
    print(widget.item);
    expenseType = widget.item['expenseType'];
    name = {'value': widget.item['employeeId'], 'text': widget.item['name']};
              ...
              Container(
                ...
                child: DropdownButtonFormField(
                  ...
                  decoration: InputDecoration(
                      ...
                      hintText: name == null ? "--select--" : name['text'],
              ...
              Container(
                ...
                child: DropdownButtonFormField(
                  ...
                  decoration: InputDecoration(
                      ...
                      hintStyle: TextStyle(color: Colors.grey[800]),
                      hintText:
                          expenseType == null ? 'Select Type' : expenseType,
                      fillColor: Colors.white),
                  // value: dropDownValue,
